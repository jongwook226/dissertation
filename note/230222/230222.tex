...
&=\sum_{i=1}^n \sum_{j=1}^n c_i \bar{c}_j \sum_{\ell_2=\kappa}^{\infty}  \sum_{m_2=-\ell_2}^{\ell_2} \int_{\mathbb{R}} e^{i \omega (t_i-t_j)} F_{\ell_2, m_2}(d\omega) \biggl\{ \gamma Y_{\ell_2}^{m_2}(y_i) + \sum_{\ell_1=0}^{\kappa-1} \sum_{m_1=-\ell_1}^{\ell_1} \gamma_{\ell_1,m_1} Y_{\ell_1}^{m_1}(y_i) Y_{\ell_2}^{m_2}(\tau_{\ell_1,m_1})  \biggl \} \\
&\quad \biggl\{ \gamma Y_{\ell_2}^{m_2}(y_j) + \sum_{\ell_1=0}^{\kappa-1} \sum_{m_1=-\ell_1}^{\ell_1} \gamma_{\ell_1,m_1} Y_{\ell_1}^{m_1}(y_j) Y_{\ell_2}^{m_2}(\tau_{\ell_1,m_1}) \biggl\}\\
&\quad \text{where } h_{ij} = t_i-t_j, \text{ and } F_{\ell_2,m_2}(d\omega) \text{ is a non-negative measure.} \\
\\
&= \sum_{\ell=\kappa}^{\infty} \sum_{m=-\ell}^{\ell} \int_{\mathbb{R}} F_{\ell_2,m_2}(d\omega) \sum_{i=1}^{n} c_i e^{-i \omega t_i} \biggl\{ \gamma Y_{\ell_2}^{m_2}(y_i) + \sum_{\ell_1=0}^{\kappa-1} \sum_{m_1=-\ell_1}^{\ell_1} \gamma_{\ell_1,m_1} Y_{\ell_1}^{m_1}(y_i) Y_{\ell_2}^{m_2}(\tau_{\ell_1,m_1})  \biggl \}\\
& \sum_{j=1}^{n} \bar{c}_j e^{-i \omega t_j} \biggl\{ \gamma Y_{\ell_2}^{m_2}(y_j) + \sum_{\ell_1=0}^{\kappa-1} \sum_{m_1=-\ell_1}^{\ell_1} \gamma_{\ell_1,m_1} Y_{\ell_1}^{m_1}(y_j) Y_{\ell_2}^{m_2}(\tau_{\ell_1,m_1}) \biggl\}\\
&= \sum_{\ell=\kappa}^{\infty}  \sum_{m=-\ell}^{\ell} \int_{\mathbb{R}} F_{\ell_2,m_2}(d\omega) \biggl | \sum_{i=1}^{n} c_i e^{i \omega t_i} \biggl\{ \gamma Y_{\ell_2}^{m_2}(y_i) + \sum_{\ell_1=0}^{\kappa-1} \sum_{m_1=-\ell_1}^{\ell_1} \gamma_{\ell_1,m_1} Y_{\ell_1}^{m_1}(y_i) Y_{\ell_2}^{m_2}(\tau_{\ell_1,m_1})  \biggl \} \biggl |^2 \ge 0\\
\end{align*}
}
\end{proof}
